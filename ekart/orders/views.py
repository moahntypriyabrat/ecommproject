...
def payments(request):
    ...
    payment_id = random.randrange(1001, 9999)
    payment = Payment(
        user=current_user,
    ...
    message = render_to_string('includes/order_received_email.html', {
        'user': current_user,'order':order, 'ordered_product': ordered_product})
    ...
    try:
        ...
        return render(request,'ekartapp/order_complete.html', context)
    except(Payment.DoesNotExist, Order.DoesNotExist):
        return redirect('home')

    # return render(request,'ekartapp/order_complete.html',)
...
def place_order(request,total=0, quantity=0):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            current_date = d.strftime('%Y%m%d') #20220119
            ...
            return render(request,'ekartapp/payments.html', context)
        else:
